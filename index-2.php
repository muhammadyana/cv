...
<div id="content" class="container">
	...
	<div id="sections-wrapper">
					...
					<div class="col-sm-4">
						<dl class="description-2">
							...
							<dd>	
								...
								<a href="https://plus.google.com/+MuhammadYanaMulyana" target="blank" class="icon icon-google-plus icon-sm icon-circle"><i class="fa fa-google-plus"></i></a>
			...
			<div class="section-content">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<h5 class="mb-5">Bootstart & Materialize Css</h5>
						<div class="progress">
							<div class="progress-bar" role="progressbar" aria-valuenow="85"></div>
						</div>
						<h5 class="mb-5">Git (Github / Bitbucket)</h5>
						<div class="progress">
		...
		<!-- Progamming Section -->
		<!-- Digital Marketing Sectio  -->
		<section id="skills" class="bg-white">
			<div class="section-content">
				<h3 class="text-muted">My Skills <br><b> Digital Marketing</b></h3>
				<div class="row">
